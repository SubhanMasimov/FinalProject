...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            IResult result = BusinessRules.Run(CheckIfProductCountOfCategoryCorrect(product.CategoryId), CheckIfNameAlreadyExists(product.ProductName), CheckIfCategoryLimitExceded());
